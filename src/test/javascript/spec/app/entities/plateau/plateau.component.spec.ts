...
import { PlateauComponent } from 'app/entities/plateau/plateau.component';
...
describe('Component Tests', () => {
  describe('Plateau Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.plateaus && comp.plateaus[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
